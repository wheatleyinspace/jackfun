...
Url: ${Er(t)}`), !0)
    ...
    let Sm = class {
        ...
        async loadS3Bundle(e) {
            return this.fetchBundle(e.file, e.css, e.base, "?v=" + e.version)
        }
        showLoaderError() {
    ...
    const $m = "production",
        ...
        Lm = {
            branch: "main",
            sha: "8292cd04c9c1f9e6dfc3ef450c0866d18be86ba8",
            lastUpdated: 1740777967757,
            version: "5.740.352",
            type: "production"
        },
        jm = {
