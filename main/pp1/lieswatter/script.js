...
const $x = Et.View.extend({
    ...
    Fx = `<div id="page-lieswatter" class="page gray" style="color:#fff">
    ...
    <div id="game" class="game pt-pageholder">
    	<div class="pt-page-off state-lobby lieswatter-page" style="background-color: #2D93F6;">
			<div class="container gameplay centered">
				...
				<form class="pure-form lobby-form">
					<button type="submit" id="lieswatter-startgame" class="button-lieswatter button-xlarge pure-button pure-input-1" data-ans="1">ВСЕ ЗДЕСЬ</button>
					<button type="button" id="lieswatter-sameplayers" class="button-lieswatter button-xlarge pure-button pure-input-1 lieswatter-endbuttons" data-ans="1">ТЕ ЖЕ ИГРОКИ</button>
					<button type="button" id="lieswatter-newplayers" class="button-lieswatter button-xlarge pure-button pure-input-1 lieswatter-endbuttons" data-ans="0">НОВЫЕ ИГРОКИ</button>	
				</form>
			</div>
		</div>
		...
		<div class="pt-page-off state-answer lieswatter-page">
			...
			<div style="padding:0px; margin:0px; width:100%;">
				...
				<div id="lieswatter-stats" style="background:#515151; padding-bottom: 5px;">
					...
					<tr>
						...
						<td style="padding:10px; width=160px;">
							<div style="text-align:center; font-family:'Ubuntu', sans-serif; color:white;"><span>БАЛЛЫ</span><br /></div>
							<div style="text-align:center;"><span id="lieswatter-score" class="ls-score-button">0</span></div>
						</td>
						<td style="padding:10px; width=80px;">
							<div style="text-align:center; font-family:'Ubuntu', sans-serif; color:white;"><span>КОМБО</span><br /></div>
				...
				<div id="lieswatter-statement-container" class="centered">
					<br/><span id="lieswatter-category" class="ls-category"></span><br /><span id="lieswatter-statement">Ждём начала игры...</span><br /><br />
				</div>
		...
		<div class="pt-page-off state-nothing lieswatter-page" style="background:#515151;" >
			<br /><span>Ответ принят!<br /><br />Ждём остальных игроков.</span><br />
		</div>
	</div>
</div>
`;
const zx = VC.extend({
    ...
    async update() {
        ...
        if (n === "RoomFull") Ot.show(Error("The room is full"), {
            ...
            const a = i.split("_")[1];
            a === "CanStart" ? (ye("#lieswatter-lobby-text").html("Нажми эту кнопку, когда все готовы"), ye("#lieswatter-startgame").show()) : a === "PostGame" && (ye("#lieswatter-lobby-text").html("Что выберешь?"), ye(".lieswatter-endbuttons").show()), this.showScreen(".state-lobby")
