...
class Ot {
    ...
    static async showAlert(e) {
        ...
        return e.customClass = {
            ...n,
            popup: "jbgModal"
        }, e.titleText = e.titleText || "Ошибка", bn.fire(e)
    }
    static async showError(e) {
        ...
        return e.customClass = {
            ...i,
            popup: "jbgModal"
        }, e.titleText = e.titleText || "Ошибка", n && (e.imageUrl = n), bn.fire(e)
    }
    ...
    zx = Da.extend({
        ...
        buttonClick(t) {
            ...
            return Pe("button").removeClass("active"), n.addClass("active"), a || (a = "choose"), this.model.get("isPlayer") ? a === "censor" ? (Pe("button").removeClass("active"), bn.close(), bn.fire({
                title: `Скрыть ${this.model.get("choices")[i].text}?`,
                text: "Передумать не получится!",
                background: "#2524c8",
                showCancelButton: !0,
                customClass: {
                ...
                type: "vote",
                vote: i
            }), this.promptComponent.model.set("html", `Спасибо. Ваш выбор: <span>${this.model.get("choices")[i].html}</span>`), this.choicesList.collection.reset()), !1
        }
    });
const Hx = Px.extend({
