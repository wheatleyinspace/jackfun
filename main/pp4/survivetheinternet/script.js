...
<button type="button" style='flex-grow:2;' class='voteButton button btn btn-lg'>
    <div class="voteTwistHeader text-left">Поиздеваться</div>
    ...
    <div class="voteResponse text-left">Ответ</div>
    <div class="voteTwistFooter text-left">Поиздеваться</div>
...
const Qx = Fx.extend({
    ...
    altTexts: {
        Airplane: "самолёт",
        ApplePicking: "сбор яблок",
        ArtMuseum: "художественный музей",
        AvocadoToast: "ужин в модном ресторане",
        BabyAnnouncement: "рассказывают о своём ребёночке",
        Barn: "пустой сарай",
        Baseball: "бейсбол",
        Basketball: "баскетбол",
        Bat: "поймать летучую мышь",
        BathroomStall: "публичный туалет",
        BBQ: "на шашлыках",
        Beach: "на пляже без зонта",
        Bear: "медведь",
        Bicycle: "езда на велосипеде",
        BirthdayParty: "детский день рождения",
        Bonfire: "сидя вокруг костра",
        BookStore: "книги",
        Boxing: "на боксёрском матче",
        BubbleBath: "горячая ванна с пеной",
        Cabin: "в лесном домике",
        Camping: "совершать поход",
        Cat: "кошка",
        Chimpanzee: "шимпанзе",
        Chinese: "печенька с предсказанием",
        CoffeeShop: "в кофейне",
        CompactCar: "винтажная малолитражка",
        ConcertStage: "на сцене",
        Condo: "в коммуналке",
        CondoInterior: "в городе",
        Convertible: "поездка на кабриолете",
        Dentist: "визит к стоматологу",
        Desert: "в пустыне",
        DMV: "в очереди за документами",
        Dog: "собака",
        Dolphin: "дельфин",
        Elephant: "слон",
        EngagementRing: "свадьба",
        FarmHouse: "в отдалённой деревне",
        FeetOnBeach: "фотки ног на пляже",
        Ferret: "хорёк",
        Field: "на цветочном поле",
        Fireworks: "запускаешь фейерверки под окнами",
        Football: "футбольный матч",
        Forest: "прогулка по лесу",
        Funeral: "похороны",
        GasStation: "на автозаправке",
        Giraffe: "жираф",
        Goldfish: "проглотить золотую рыбку",
        Gorilla: "горилла",
        Graduation: "школьный выпускной",
        Guacamole: "гуакамоле",
        Gym: "ходить в спортзал",
        Gyro: "шаурма",
        Hamburger: "хороший гамбургер",
        Hockey: "хоккей",
        HomeRepair: "ремонт дома",
        Horse: "на лошади",
        HorseRace: "конные скачки",
        HotAirBalloon: "подняться на воздушном шаре",
        HotDogs: "взятый с собой хот-дог",
        HouseParty: "в клубе",
        IceCream: "мороженое",
        Igloo: "в Антарктиде",
        Indian: "пикник индийской кухни",
        Island: "на острове",
        Jeep: "спортивный джип",
        Jungle: "в лесах Амазонки",
        Kite: "когда запускаешь воздушного змея",
        Kittens: "котята",
        Laundromat: "прачечная",
        Lion: "лев",
        London: "в Лондоне",
        Mansion: "особняк в глуши",
        MeatSkewer: "шашлык",
        Meditation: "медитация",
        Mexican: "пробовать мексиканскую кухню",
        Minivan: "минивен",
        Moose: "лось",
        Motel: "в обычном мотеле",
        Motorcycle: "езда на мотоцикле",
        Mountains: "горный поход",
        MovieTheater: "кинотеатр",
        Moving: "переезд",
        Museum: "поход в музей",
        Nascar: "автомобильные гонки",
        NewYorkCity: "в Нью-Йорке",
        Office: "в офисе",
        Orangutan: "обезьяна",
        Parade: "проехать в колонне парада",
        Paris: "в Париже",
        ParkingTicket: "штраф за парковку",
        Park: "в парке",
        PickupTruck: "пикап",
        Pig: "большая свинья",
        Pizza: "вечеринка с пиццей",
        PoolParty: "в бассейне",
        PostOffice: "в очереди на почту",
        Puppies: "щеночки",
        Rabbit: "кролик",
        Rainstorm: "попасть под внезапный ливень",
        Rollerblades: "роликовые коньки",
        RollerCoaster: "катание на американских горках",
        RomanticGetaway: "романтический отдых",
        Russia: "Красная площадь, собор Василия Блаженного",
        Sailboat: "на яхте",
        Salad: "салат",
        Salmon: "лосось",
        SanFrancisco: "Сан-Франциско",
        Segway: "кто-то на сегвее",
        SemiTruck: "в грузовике дальнобойщиков",
        ShootingStar: "увидели падающую звезду",
        Skyscraper: "с крыши небоскрёба",
        Snake: "большая змея",
        Soccer: "футбол",
        Spider: "пауки",
        StationWagon: "старый вагон",
        Statue: "памятник себе",
        Steak: "после хорошего бифштекса",
        SubwayCar: "вагон метро",
        Suitcase: "собирать вещи для путешествия",
        Sunset: "смотреть на закат",
        Tennis: "игра в теннис",
        Traffic: "в пробке",
        Train: "живописная поездка на поезде",
        Vegas: "Лас-Вегас",
        Volleyball: "игра в волейбол",
        Voting: "первое голосование на выборах",
        VR: "кто-то в очках виртуальной реальности",
        Wedding: "на свадьбу",
        Wrestling: "рестлер",
        WritingDesk: "сидя за рабочим столом",
        Yoga: "занятия йогой",
    },
    getGameLayout(t) {
        switch (t) {
