...
class kt {
    ...
    static async showAlert(e) {
        ...
        return e.customClass = {
            ...n,
            popup: "jbgModal"
        }, e.titleText = e.titleText || "Ошибка", Mt.fire(e)
    }
    static async showError(e) {
        ...
        return e.customClass = {
            ...i,
            popup: "jbgModal"
        }, e.titleText = e.titleText || "Ошибка", n && (e.imageUrl = n), Mt.fire(e)
    }
...
<button class="dateButton btn pull-right playerColor">СВИДАНИЕ</button>
                ...
                attributes: [{
                    ...
                    onGet(t) {
                        const e = t[0],
                            n = t[1];
                        let i = "";
                        return i += `${n.name}`, n.monster.name !== "Human" && (i += ` – ${n.monster.name} `), e && (i += ` has ${e} unread`), i
                    }
                }]
            },
            ".playerName": {
...
<div class="chatMessageText">
    ...
    eE = `<div class="row">
    <div class="col-xs-2">
        <button class="chatBack playerColorBackground btn pull-left unread">Чат</button>
    </div>
    <div class="col-xs-8 text-center">
...
`,
    ...
    <div class="playerInDisguise">(в маскировке)</div>
</div>
<div class="profileContent">
    <div class="closeButton"></div>
    <div class="blockedMessage">Ты не получаешь сообщения от Kimberly</div>
    ...
    <div class="monsterPower">
        <span class="monsterPowerIntro">Способность:</span>
    ...
    <button class='startChattingButton btn'>Начать общение!</button>
    <button class="blockButton btn">Заблокировать</button>
</div>`,
    yl = ht.View.extend({
        ...
        bindings: {
            ...
            ".blockedMessage": {
                observe: "blocked",
                onGet(t) {
                    return t === !0 ? `Ты не получаешь сообщения от ${this.model.attributes.name}` : ""
                }
            },
            ".monsterClassIntro": {
                observe: ["self", "monster"],
                onGet(t) {
                    return t[0] === !0 ? `Ты – `:`Этот игрок – `
                }
            },
            ".monsterClassName": {
                observe: "monster",
            ...
            ".blockButton": {
                observe: "blocked",
                onGet(t) {
                    return t === !0 ? "Разблокировать" : "Заблокировать"
                },
                attributes: [{
                    name: "style",
                    observe: "self",
    ...
    aE = ht.View.extend({
        ...
        initialize(t) {
            ...
            try {
                ...
                console.error("Не удалось загрузить звук", e)
            }
        ...
        async update() {
            const t = this;
            if (this.player = this.model.get("player"), this.chat = this.model.get("chat") || {}, this.model.get("chosenDateUserId") && (this.chat.mode = "browse"), this.player && (this.summaryTopComponent.model.set("player", this.player), this.chat.mode === "chat" ? (this.summaryTopComponent.model.set("mode", "ВРЕМЯ ОБЩЕНИЯ"), this.summaryTopComponent.model.set("description", "Кликни на игрока, чтобы написать ему")) : this.chat.mode === "date" ? (this.summaryTopComponent.model.set("mode", "ВРЕМЯ ВЫБОРА"), this.summaryTopComponent.model.set("description", "С кем хочешь пойти на свидание?")) : this.chat.mode === "browse" && this.model.get("chosenDateUserId") !== null && (this.summaryTopComponent.model.set("mode", "СВИДАНИЕ ВЫБРАНО"), this.summaryTopComponent.model.set("description", "Ждём выбор остальных игроков"))), this.chat) {
                let e;
                if (this.client.isRole("player")) {
                    ...
                    this.summaryCollection.set(this.chat.conversations), this.chat.mode === "chat" ? (this.bottomComponent.model.set("text", `Осталось ${this.chat.messagesAvailableToSend}${this.chat.messagesAvailableToSend===1?" сообщение ":this.chat.messagesAvailableToSend===0?" сообщений":" сообщения"}`), this.bottomComponent.model.set("background", this.player.color.medium)) : this.chat.mode === "date" ? this.bottomComponent.model.set("text", "Нажми кнопку СВИДАНИЕ на этом экране, или внутри беседы.") : this.bottomComponent.model.set("text", ""), this.chat.mode && this.mode !== this.chat.mode && (!this.detailContactId && this.getRegion("summary") && this.getRegion("summary").currentView === this.summaryList ? this.showChatSummary() : this.detailContactId && this.showChatDetail(this.detailContactId)), this.mode = this.chat.mode, this.chat.showProfile && this.showPlayerProfile(this.player, !0)
                } else if (this.client.isRole("audience")) {
                    if (this.model.changed.alerts && this.showAlerts(this.model.get("alerts")), this.summaryTopComponent.model.set("player", this.player), this.summaryTopComponent.model.set("mode", "ЗРИТЕЛИ"), this.summaryTopComponent.model.set("description", "Голосуй за следующую фразу"), e = this.chat && this.chat.history.length > this.chatDetailCollection.length, this.chat && this.chat.history) {
...
const cE = Us.extend({
    ...
    parseBlob(t) {
        return t.playerInfo = t.player || {}, t.playerInfo.username = t.playerName || "Зритель", t.player && t.player.color && (t.playerInfo.topBarColor = t.player.color.dark, t.playerInfo.buttonColor = t.player.color.dark, t.playerInfo.avatar = t.player.character ? t.player.character.frame : null), t.color && (t.playerInfo.topBarColor = t.color.dark, t.playerInfo.buttonColor = t.color.dark), t.state === "Logo" && (t.message = {
            html: t.message
