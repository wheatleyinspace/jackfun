...
class Ot {
    ...
    static async showAlert(e) {
        ...
        return e.customClass = {
            ...n,
            popup: "jbgModal"
        }, e.titleText = e.titleText || "Ошибка", en.fire(e)
    }
    static async showError(e) {
        ...
        return e.customClass = {
            ...i,
            popup: "jbgModal"
        }, e.titleText = e.titleText || "Ошибка", n && (e.imageUrl = n), en.fire(e)
    }
...
const Hx = mt.View.extend({
    ...
    qx = `<div class="overdrawnBold title">Нарисуй своё имя ниже</div>
<div id="nametag" class="nametag">
    <div id="header" class="nametagHeader overdrawnBold">Привет, я</div>
    <div id="sketchpad" class="nametagBody"></div>
</div>
<button id="submitButton" class="button submitButton">Отправить</button>
<div id="vipWarning" class="text">Чтобы продолжить, нужно нарисовать своё имя и нажать "Отправить".</div>`,
    Wx = Pn.extend({
        defaults: {
            live: !0,
            size: {
    ...
    Yx = `<div class="text">Режим свободного рисования</div>
...
<ul id="pre-sketchpad" class="nav nav-colors pre-sketchpad">
    <li class="pull-right button-pad">
        <button id="resetall" class="button">Очистить всё</button>
    </li>
...
`,
    ...
    <button id='censorOptions' class='button'>Цензурирование</button>
    <div id='next-up'>
        <span id='next-up-span'>Ты следующий!</span>
    </div>
    <div class="audienceInstruction col-xs-12 text">У зрителей есть только одна реакция на рисунок, так что используй её с умом!</div>
</div>`,
    a1 = mt.View.extend({
        bindings: {
            ":el": {
...
`,
    ...
    d1 = Ni.extend({
        ...
        bindings: Ve.extend({}, Ni.prototype.bindings, {
            ...
            "#chosen": {
                observe: "chosen",
                onGet(t) {
                    return t ? "Спасибо! Каждый голос на счету." : null
                }
            }
        }),
        initialize(t) {
    ...
    f1 = Va.extend({
        ...
        sendInput() {
            ...
            return !t || t.length === 0 ? (this.inputComponent.model.set("error", "Попробуй что-то написать в ответе!"), !1) : (this.shouldSubmit = !1, this.model.sendMessage({
                entry: t
