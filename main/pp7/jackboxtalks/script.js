            ...
            if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
                ...
                try {
                    ...
                    console.error(i), Ot.show("alert", {
                        ...
                        text: `Не удалось подключиться к камере вашего устройства. Перезагрузите страницу и попробуйте ещё, или выберите ${t == "avatar" ? "аватар" : "рисунок"}.`,
                        willClose: () => {
    ...
    Qx = Vn.extend({
        ...
        sendInput(t) {
            if (this.sketchpadComponent.getLines().length === 0) {
                Ot.show(Error("Надо что-то нарисовать!"));
                return
            }
...
<div class="cameraControls">
    <button id="exitButton" class="button exitButton" aria-label="Выход"></button>
    <div class="buttons pre">
        <button id="switchButton" class="button switchButton" aria-label="Сменить камеру"></button>
    ...
    <div class="buttons post">
        ...
        <button id="confirmButton" class="button confirmButton" aria-label="Подтвердить">ОСТАВИТЬ</button>
    </div>
</div>
