...
const BC = Et.View.extend({
        ...
        showTwitchBroadcasterDialog(t) {
            ...
            e += "<div class='success'>Вы успешно подключены к Jackbox Audience Kit Twitch Extension.</div>", this.lacksAudience ? e += "<div class='warning'>В ЭТОЙ ИГРЕ НЕТ ФУНКЦИИ ЗРИТЕЛЕЙ</div>" : this.client.roomInfo.audienceEnabled || (e += "<div class='warning'>В ЭТОЙ ИГРЕ НЕТ ФУНКЦИИ ЗРИТЕЛЕЙ</div>"), Ot.show("custom", {
                html: e,
                position: "bottom",
                timer: t,
...
Et.View.extend({
    ...
    showTwitchBroadcasterDialog(t) {
        ...
        e += `
            ...
            </div>`, this.lacksAudience ? e += "<div class='warning'>В ЭТОЙ ИГРЕ НЕТ ФУНКЦИИ ЗРИТЕЛЕЙ</div>" : this.client.roomInfo.audienceEnabled || (e += "<div class='warning'>В ЭТОЙ ИГРЕ НЕТ ФУНКЦИИ ЗРИТЕЛЕЙ</div>"), Ot.show("custom", {
            html: e,
            position: "bottom",
            timer: t,
            backdrop: "transparent",
		...
		<div class="pt-page-off state-lobby fibbage-page">\r
			<div class="container">\r
				...
				<form class="pure-form">\r
					<button type="button" id="fibbage-startgame" class="button-fibbage button-xlarge pure-button pure-input-1">ВСЕ ЗДЕСЬ</button>\r
					<button type="button" id="fibbage-stopcountdown" class="button-fibbage  button-xlarge pure-button pure-input-1">ОТМЕНА</button>\r
					<button type="button" id="fibbage-sameplayers" class="button-fibbage  button-xlarge pure-button pure-input-1 fibbage-endbuttons">ТЕ ЖЕ ИГРОКИ</button>\r
					<button type="button" id="fibbage-newplayers" class="button-fibbage  button-xlarge pure-button pure-input-1 fibbage-endbuttons">НОВЫЕ ИГРОКИ</button>	\r
				</form>\r
			</div>\r
		</div>\r
\r
...
\r
        <div class="pt-page-off state-pickbloop fibbage-page">\r
			<div class="container">\r
				<br /><span>ВЫБЕРИ СВОЙ ЗВУК ДЛЯ ИГРЫ</span><br />\r
...
\r
		<div class="pt-page-off state-choosing fibbage-page">\r
			<div class="container">\r
				<br /><span>Ты выбираешь категорию!</span><br />\r
				<div class="button-container">\r
					<form class="pure-form">\r
...
\r
				...
				<form class="pure-form" id="fibbage-enterlie-field">\r
					<div class="pure-u-1">\r
						<input id="fibbage-lie-input" name="fibbage-lie" class="pure-input-1 capitalize jbg-input fibbage-lie-input" type="text" maxlength="45" placeholder="ВВЕДИ ЛОЖЬ" autocapitalize="off" autocorrect="off" autocomplete="off">\r
					</div>\r
					<button type="button" id="fibbage-lieforme" class="button-fibbage button-large pure-button capitalize left">ПОДСКАЗКА<br/>(половина очков)</button>\r
					<button type="submit" id="fibbage-submitlie" class="button-fibbage button-large pure-button capitalize right"><i class="fas fa-paper-plane"></i>&nbsp;&nbsp;ОТПРАВИТЬ</button>\r
			...
			<div class="container">\r
				...
				<form id="fibbage-defib" class="pure-form">\r
					<button type="button" data-param="defib" class="pure-input-1 fibbage-defib-button button-large pure-button button-fibbage button-fibbage-defib">\r
						<img class="defib-icon" src='main/pp2/fibbage2/fibbage2/defib.png' />&nbsp;&nbsp;&nbsp;&nbsp;РАЗ<font color="red">БРЕД</font>ОВАТЕЛЬ\r
					</button>\r
					<br /><span>СОКРАТИ СВОЙ ВЫБОР ДО ДВУХ ВАРИАНТОВ!</span>\r
				</form>\r
			</div>\r
		</div>\r
\r
...
\r
		<div class="pt-page-off state-liereceived fibbage-page">\r
			<br /><span>ЛОЖЬ ВВЕДЕНА!<br />Ожидаем остальных игроков.</span><br />\r
		</div>\r
\r
		<div class="pt-page-off state-lyingdone fibbage-page">\r
			<br /><span>ВСЕ ОТВЕТЫ ПРИНЯТЫ!</span><br />\r
		</div>		\r
\r
...
\r
		<div class="pt-page-off state-audience-join fibbage-page">\r
			...
			<span>\r
				<br /><br />\r
				Ты можешь \u201Cприсудить бонусные баллы\u201D ответу, который тебе понравился (один раз за вопрос).\r
				<br /><br />\r
				- И -\r
				<br /><br />\r
				Ты также можешь угадывать правду на каждом вопросе! Найди все 7 правдивых ответов и получи бесплатный странный бонус в подарок - самое то для вечеринок!\r
			</span>\r
			<br />\r
		</div>\r
\r
		<div class="pt-page-off state-audience-postgame fibbage-page">\r
			<div class="container">\r
				...
				<br /><br /><span>ФИНАЛЬНЫЙ СЧЁТ</span><br /><br />\r
...
\r
		<div class="pt-page-off state-audience-score fibbage-page">\r
			<div class="container">\r
				<br /><img style="margin-left:auto; margin-right:auto; max-width:75%; max-height:75%;"  src='main/pp2/fibbage2/fibbage2/logo.png'>\r
				<br /><br /><span>СЧЁТ НА ДАННЫЙ МОМЕНТ:</span><br /><br />\r
...
const zx = BC.extend({
    ...
    currentQuip: "",
    currentFact: "",
    bonusFacts: ["Во время гонки на собачьих упряжках \"Идитарод\" 1988 года на Аляске Джон Сутер участвовал не с традиционной командой ездовых собак, а с командой пуделей! (Он проиграл.)", "Лающие звуки велоцирапторов в фильме \"Парк Юрского периода\" были созданы путём записи звуков спаривающихся черепах.", "Согласно переписи населения Сиэтла 2011 года, в городе было больше собак, чем детей.", "Бывший президент США Уоррен Г. Хардинг однажды проиграл фарфоровую посуду Белого дома в покер!", "Изначально изобретатели пупырчатой плёнки пытались создать пластиковые обои!", "Стрижка пуделей была показательным видом спорта на Олимпийских играх 1900 года!", "Чипсы Doritos были изобретены в Диснейленде!", "Доктор Сьюз сделал предложение руки и сердца своей жене, когда она ехала на заднем сиденье его мотоцикла!", "В 2015 году команда \"Атланта Фэлконс\" была оштрафована на 350 000 долларов и лишена выбора в драфте национальной футбольной лиге 2016 года после того, как было обнаружено, что они транслировали фальшивые звуки толпы через динамики на стадионе.", "Один из первых прототипов компьютерной мыши Apple был сделан из маслёнки и дезодоранта-ролика!", "В Балтиморе есть метал-группа, вокалистом которой является жако. Они называются Hatebeak.", "Музыкальная партитура для сиквела мюзикла \"Призрак оперы\" Эндрю Ллойда Уэббера была, и это правда, удалена его кошкой.", "Диснеевским аниматорам было приказано сделать Аладдина похожим на Тома Круза и Майкла Дж. Фокса.", "Первый спортивный бюстгальтер был сконструирован путём сшивания двух мужских суспензориев!", "Первоначально создатель мультсериала \"Закусочная Боба\" намеревался сделать семью Белчеров каннибалами, а не владельцами закусочной.", "Если вы поклонник сериала \"Во все тяжкие\", то жителям дома Уолтера Уайта, вероятно, не нравится ваша любовь, потому что люди продолжают имитировать знаменитую сцену и бросать пиццу на крышу их дома.", "Если вы путешествуете в итальянский городок Лальо, будьте осторожны. Там установлен штраф в 500 евро за то, что вы приблизитесь слишком близко к Джорджу Клуни. (Он любит отдыхать там.)", "Если вы ищете идеальное место для вашей следующей вечеринки или свадьбы, рассмотрите Музей 6-го этажа, который теперь сдаётся в аренду. Это здание, из которого, как утверждают, Ли Харви Освальд застрелил Джона Ф. Кеннеди! Романтично!", "Посаженное в 2001 году в Лос-Анджелесе дерево в память о жизни Джорджа Харрисона перестало существовать в 2015 году после того, как его погубили... жуки.", "В Нью-Йорке ежегодно происходит около 2100 взрывов канализационных люков, многие из которых серьёзно калечат прохожих. Это всего лишь около 6 случаев в день, не волнуйтесь. Вероятность того, что вас это коснётся, довольно мала."],
    ...
    */
    ...
    updatePlayer() {
        ...
        if (n === "Lobby_PickBloop") {
            ...
            if (n && n.split("_")[0] === "Lobby") {
                ...
                const a = n.split("_")[1];
                a === "WaitingForMore" ? se("#fibbage-lobby-text").html("Ожидаем других игроков...") : a === "CanStart" ? (se("#fibbage-lobby-text").html("Нажми эту кнопку, когда все присоединились"), se("#fibbage-startgame").show()) : a === "Countdown" ? (se("#fibbage-lobby-text").html("Нажми эту кнопку, чтобы отменить запуск"), se("#fibbage-stopcountdown").show()) : a === "PostGameHost" ? (se("#fibbage-lobby-text").html("Что выберешь?"), se(".fibbage-endbuttons").show()) : a === "PostGame" && se("#fibbage-lobby-text").html("Waiting for host decision"), this.showScreen(".state-lobby")
            }
        ...
        else if (i === "Gameplay_Round") se(".round-text").html(`РАУНД ${e.round}`), this.showScreen(".state-round");
            ...
            } else se("#notchoosing").html(`${Mt.safeText(e.choosingPlayerName)} выбирает категорию`), this.showScreen(".state-notchoosing");
            ...
            if (n === "Gameplay_EnterLie") {
                ...
                if (t.showError) {
                    ...
                    se("#fibbage-submit-alert").html("Ты ввёл правду! Придумай ложь!"), a.addClass("alert-info"), a.removeClass("alert-danger"), a.show()
                }
            ...
            if (t.choosingDone || t.chosen !== void 0) {
                se("#chooselikes-choice").html(t.chosen ? `Твой выбор: ${t.chosen}` : "Выбор не был сделан"), se("#chooselikes-text").html("Присуди бонусные лайки");
                let d = "";
                ...
                se("#chooselie-text").html("Найди правду!");
                let d = "";
    ...
    updateAudienceLikes() {
        const t = this.model.get("room");
        se("#audience-chooselikes-choice").html(`Твой выбор: ${this.currentChoice===""?"НЕТ ОТВЕТА!":this.currentChoice}`), se("#audience-chooselikes-text").html("Присуди бонусный лайк");
    ...
    updateAudience() {
        ...
        if (e === "Gameplay_ChooseLie") {
        ...
        else if (e === "Gameplay_CategorySelection") se("#notchoosing").html(`${Mt.safeText(t.choosingPlayerName)} выбирает категорию`), this.showScreen(".state-notchoosing");
        else if (e === "Gameplay_Round") se(".round-text").html(`РАУНД ${t.round}`), this.showScreen(".state-round");
            ...
            if (se("#audience-postgame-score").html(`<span>${this.numCorrect}/7</span>`), this.numCorrect === 7) {
                if (se("#audience-postgame-score-quip").html("Ты выиграл бесплатный бонусный факт!"), this.currentFact === "") {
                    const n = this.bonusFacts;
                    this.currentFact = n[Math.floor(Math.random() * n.length)]
                }
                se("#audience-bonus-fact").html(this.currentFact), se("#audience-bonus-quip").html("Сыграй ещё и узнаешь больше..."), se(".audience-bonus-fact").show(), se(".audience-bonus-quip").show()
            } else {
    ...
    submitLie() {
        ...
        if (t = t.replace(/\s\s+/g, " ").trim(), t.length === 0) {
            ...
            return se("#fibbage-submit-alert").html("Нужно что-то написать! Используй подсказку, если нужна помощь."), e.removeClass("alert-info"), e.addClass("alert-danger"), e.show(), !1
        }
        return this.client.send("SendMessageToRoomOwner", {
            lieEntered: t,
            usedSuggestion: !1
    ...
    sanitize(t) {
        return t && t.replace(/[^A-Z0-9\u00A1\u0020-\u002F\u00BF-\u00FF\u0406-\u0408\u0410-\u044F\u0401\u0451\u0456-\u0458!?*$+\-’'_ .,]/gi, "").replace(/'/g, "\u2019").trim()
    },
    onResize() {
        const t = se(window).width(),
