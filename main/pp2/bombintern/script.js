...
const qx = Et.View.extend({
    ...
    <link href="https://fonts.googleapis.com/css?family=Podkova:400,700&subset=cyrillic" rel="stylesheet" type="text/css" >\r
\r
    <div id="player">\r
        <h1><%=username%></h1>\r
    </div>\r
        ...
        <div class="pt-page-off state-lobby bombintern-page">\r
            <div class="container">\r
                ...
                <form class="pure-form">\r
                    <button type="button" id="bombintern-startgame" class="button-bombintern button-xlarge pure-button pure-input-1">НАЧАТЬ</button>\r
                    <button type="button" id="bombintern-stopcountdown" class="button-bombintern  button-xlarge pure-button pure-input-1">ОТМЕНА</button>\r
                </form>\r
            </div>\r
        </div>\r
\r
        <div class="pt-page-off state-dayend bombintern-page">\r
            <div class="container">\r
                ...
                <form class="pure-form">\r
                    <button type="button" id="bombintern-nextday" class="button-bombintern button-xlarge pure-button pure-input-1">СЛЕДУЮЩИЙ ДЕНЬ</button>\r
                    <button type="button" id="bombintern-retryday" class="button-bombintern button-xlarge pure-button pure-input-1">ПОВТОРИТЬ ДЕНЬ</button>\r
                    <button type="button" id="bombintern-menuday" class="button-bombintern  button-xlarge pure-button pure-input-1">МЕНЮ</button>\r
                </form>\r
            </div>\r
        </div>\r
\r
        <div class="pt-page-off state-gameover bombintern-page">\r
            <div class="container">\r
                ...
                <form class="pure-form">\r
                    <button type="button" id="bombintern-retry" class="button-bombintern button-xlarge pure-button pure-input-1">ПОВТОРИТЬ</button>\r
                    <button type="button" id="bombintern-menu" class="button-bombintern  button-xlarge pure-button pure-input-1">МЕНЮ</button>\r
                </form>\r
        ...
        switch (Ae(".bombintern-page").css("background-color", v), n) {
            case "Lobby":
                switch (this.$el.find("#bombintern-startgame").hide(), this.$el.find("#bombintern-stopcountdown").hide(), a) {
                    case "WaitingForMore":
                        this.$el.find("#bombintern-lobby-text").html("Ожидаем других игроков..."), this.showScreen(".state-lobby");
                        break;
                    case "CanStart":
                        this.$el.find("#bombintern-lobby-text").html("Нажми эту кнопку, когда все присоединились"), this.$el.find("#bombintern-startgame").show(), this.showScreen(".state-lobby");
                        break;
                    case "Countdown":
                        this.$el.find("#bombintern-lobby-text").html("Нажми эту кнопку, чтобы отменить запуск"), this.$el.find("#bombintern-stopcountdown").show(), this.showScreen(".state-lobby");
                        break;
                    case "WaitingToStart":
                        this.$el.find("#bombintern-lobby-text").html("Ожидаем начала игры"), this.showScreen(".state-lobby");
                        break
                }
                break;
            case "Logo":
                ...
                switch (Ae(".bombintern-rules").html(""), this.lastPuzzle = a, a) {
                    case "SmashPuzzle":
                        if (this.$el.find("#bombintern-smashpuzzle-triggers").html(""), this.buildRuleFolder(a, "bombintern-smashpuzzle-rules"), i.smasher === !0) {
                            t = "<div class='bomb-header' id='button-header'><span>НАЖМИ НА КНОПКИ НИЖЕ, ЧТОБЫ ЧТО-ТО РАЗБИТЬ</span></div>";
                    ...
                    case "WiredBomb":
                        if (this.$el.find("#bombintern-wiredbomb-triggers").html(""), this.buildRuleFolder(a, "bombintern-wiredbomb-rules"), i.triggers && i.triggers.length > 0) {
                            t = i.triggers[0]?.name == "Щупальце" ? 
                                "<div class='bomb-header' id='button-header'><span>НАЖИМАЙ НА КНОПКИ, ЧТОБЫ МАССИРОВАТЬ ЩУПАЛЬЦА</span></div>" :
                                "<div class='bomb-header' id='button-header'><span>НАЖИМАЙ НА КНОПКИ, ЧТОБЫ ПЕРЕРЕЗАТЬ ПРОВОДА</span></div>";
                            for (let _ = 0; _ < i.triggers.length; ++_) {
                                const S = i.triggers[_],
                                    O = S.name || "Провод";
                    ...
                    case "CoffeeBomb":
                        if (this.$el.find("#bombintern-coffeebomb-triggers").html(""), this.buildRuleFolder(a, "bombintern-coffeebomb-rules"), i.triggers && i.triggers.length > 0) {
                            t = "<div class='bomb-header' id='button-header'><span>ДОБАВЬ ИЛИ УДАЛИ ИНГРЕДИЕНТЫ</span></div>";
                            for (let _ = 0; _ < i.triggers.length; ++_) {
                                const S = i.triggers[_];
                            ...
                            t += "<div class='bomb-header' id='brew-header'><span>НАЖМИ, ЧТОБЫ ПРИГОТОВИТЬ</span></div>", t += "<button type='button' class='pure-input-1 bombintern-coffeebomb-brew-button button-large pure-button button-bombintern'>Приготовить</button>", this.$el.find("#bombintern-coffeebomb-triggers").html(t)
                        }
                    ...
                    case "FilingBomb":
                        if (this.$el.find("#bombintern-filingbomb-triggers").html(""), this.buildRuleFolder(a, "bombintern-filingbomb-rules"), i.triggers.length > 0) {
                            t = "<div id='button-header'<br /><span>ОТСОРТИРУЙ ДАННЫЕ</span><br /></div>";
                            for (let _ = 0; _ < i.triggers.length; ++_) {
                                const S = i.triggers[_];
                    ...
                    case "CopierBomb":
                        if (this.$el.find("#bombintern-copierbomb-rules").html(""), this.$el.find("#bombintern-copierbomb-triggers").html(""), this.buildRuleFolder(a, "bombintern-copierbomb-rules"), i.triggers.length > 0) {
                            for (let _ = 0; _ < i.triggers.length; ++_) {
                                ...
                                const S = i.triggers[_],
                                    O = S.text || S.name;
                                t += `<button type='button' data-param='${S.index}' class='pure-input-1 bombintern-copierbomb-button button-large pure-button button-bombintern'>`, t += `<span>${O}</span>`, S.type === "button" ? t += `<div class='copier-control-image'><img src='${new URL("main/pp2/bombintern/assets/5bdafb63.png",self.location).href}'/></div>` : S.type === "action" ? t += `<div class='copier-control-image'><img src='${new URL("main/pp2/bombintern/assets/8c5e7663.png",self.location).href}'/></div>` : S.type === "load" ? t += `<div class='copier-control-image'><img src='${new URL("main/pp2/bombintern/assets/bfc3719e.png",self.location).href}'/></div>` : S.type === "panel" ? S.state === 0 ? (t += `<div class='copier-control-image'><img src='${new URL("main/pp2/bombintern/assets/13091a8a.png",self.location).href}'/></div>`, t += "(закрыто)") : (t += `<div class='copier-control-image'><img src='${new URL("main/pp2/bombintern/assets/99e487b3.png",self.location).href}'/></div>`, t += "(открыто)") : S.type === "setting" && (t += `<div class='copier-control-image'><img src='${new URL(Object.assign({"../images/copier-knob-1.png":Cc,"../images/copier-knob-2.png":xc,"../images/copier-knob-3.png":Ec,"../images/copier-knob-4.png":_c})[`../images/copier-knob-${
                                    S.value + 1
                                }.png`],self.location).href}'/></div>`, t += S.options[S.value]), t += "</button>", t += "</div>"
                            }
                    ...
                    case "KeypadBomb":
                        if (this.$el.find("#bombintern-keypadbomb-triggers").html(""), this.buildRuleFolder(a, "bombintern-keypadbomb-rules"), i.triggers && i.triggers.length > 0) {
                            t = "<div class='bomb-header' id='button-header'><span>Введи код из 4 цифр:</span></div>";
                            for (let _ = 0; _ < i.triggers.length; ++_) {
                                const S = i.triggers[_];
                                let O = S.key;
            ...
            case "DayEnd":
                switch (a) {
                    case "DayEndDecision":
                        this.$el.find("#bombintern-dayend-text").html("День пройден!"), this.showScreen(".state-dayend");
                        break;
                    default:
                        this.$el.find("#bombintern-message-text").html("День пройден!"), this.showScreen(".state-message");
                        break
                }
                break;
            case "GameOver":
    ...
    async buildRuleFolder(t, e) {
        ...
        if (a.rules && a.rules.length > 0 || a.sort && a.sort.length > 0) {
            switch (n += "<div class='bomb-header' id='instruction-header'>", t) {
                case "SmashPuzzle":
                    n += "<span>ПРОЧИТАЙТЕ ИНСТРУКЦИИ НИЖЕ, ЧТОБЫ ЧТО-ТО РАЗБИТЬ!</span>";
                    break;
                case "WiredBomb":
                    n += "<span>СЛЕДУЙТЕ ИНСТРУКЦИЯМ</span>";
                    break;
                case "CoffeeBomb":
                    n += "<span>СЛЕДУЙТЕ ИНСТРУКЦИЯМ</span>";
                    break;
            ...
            if (n += "</div>", n += "<div class='rules-folder-tab'><span>ИНСТРУКЦИЯ</span></div><div class='rules-folder'>", t === "FilingBomb") n += `<div class='rules-page'><span>${a.sort}</span></div>`;
                ...
                for (let f = 0; f < a.rules.length; ++f) n += "<div class='rules-page copier-rule-page'>", i = a.rules[f], i.header !== "" && (n += `<div class='copier-icon'><img src='${new URL(Object.assign({"../images/AlienBlue.png":Yx,"../images/AlienGreen.png":Kx,"../images/AlienPink.png":Jx,"../images/AlienPurple.png":Qx,"../images/AlienYellow.png":Zx,"../images/GreenDiamond.png":e1,"../images/OrangeArrow.png":t1,"../images/RedCircle.png":n1,"../images/WhiteSquare.png":i1,"../images/YellowTriangle.png":r1,"../images/copier-action.png":s1,"../images/copier-button-down.png":o1,"../images/copier-button.png":a1,"../images/copier-knob-1.png":Cc,"../images/copier-knob-2.png":xc,"../images/copier-knob-3.png":Ec,"../images/copier-knob-4.png":_c,"../images/copier-load.png":l1,"../images/copier-panel-closed.png":c1,"../images/copier-panel-open.png":u1,"../images/jumpbttncutwires.png":h1,"../images/jumpbttnrules.png":d1,"../images/logo.png":f1,"../images/panel_open_alt.png":p1})[`../images/${
                    i.header
                }.png`],self.location).href}'/></div>`), n += `<span class='bombintern-rule copier-rule'>${i.body}</span>`, n += "</div>";
            else
            ...
            case "SmashPuzzle":
                n += "<div class='bomb-header' id='instruction-header'><span>ТЫ РАЗБИВАЕШЬ!</span></div>";
                break;
            case "WiredBomb":
                n += "<div class='bomb-header' id='instruction-header'><span>ТЫ ПЕРЕРЕЗАЕШЬ ПРОВОДА!</span></div>";
                break;
            case "CoffeeBomb":
                n += "<div class='bomb-header' id='instruction-header'><span>ТЫ ЗАВЕРШАЕШЬ ПРОЦЕСС!</span></div>";
                break;
            case "FilingBomb":
                n += "<div class='bomb-header' id='instruction-header'><span>ТЫ СОРТИРУЕШЬ!</span></div>";
                break;
            case "CopierBomb":
                n += "<div class='bomb-header' id='instruction-header'><span>ПОЧИНИТЕ КСЕРОКС!</span></div>";
                break;
            case "KeypadBomb":
                n += "<div class='bomb-header' id='instruction-header'><span>УЗНАЙТЕ КОД!</span></div>";
                break
        }
        this.$el.find(`#${e}`).html(n)
    },
