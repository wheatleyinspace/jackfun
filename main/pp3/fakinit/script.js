                ...
                <div id="lobby-main-menu">\r
                    <div class="fakinit-change-name-dialog">\r
                        <form class="fakinit-name-change-form" style="display:none;">\r
                            <div class="form-group">\r
                                <input type="input" class="form-control fakinit-input" id="fakinitNameChange" placeholder="имя" maxLength=12>\r
                            </div>\r
                            <div class="row">\r
                                <div class="col-xs-12">\r
                                    <button id="fakinit-name-change-confirm" type="submit" class="fakinit-button fakinit-button-secondary pull-right">Подтвердить</button>\r
                                    <button id="fakinit-name-change-cancel" class="fakinit-button fakinit-button-secondary pull-right">Отмена</button>\r
                                </div>\r
                            </div>\r
                        </form>\r
                        <p class="fakinit-name-change-button"><button id="fakinit-name-change" class="fakinit-button fakinit-button-secondary">Сменить имя?</button></p>\r
                        <p><span class="fakinit-text fakinit-text-instruction fakinit-category-color">Используй своё настоящее имя, чтобы тебя было легко отличать от остальных</span></p>\r
                    </div>\r
                    <form class="pure-form">\r
                        <button type="button" id="fakinit-startgame" class="fakinit-button btn btn-lg btn-block">Все здесь</button>\r
                        <button type="button" id="fakinit-stopcountdown" class="fakinit-button btn btn-lg btn-block">ОТМЕНА</button>\r
                        ...
                        <button type="button" id="fakinit-sameplayers" class="fakinit-button btn btn-lg btn-block fakinit-endbuttons">ТЕ ЖЕ ИГРОКИ</button>\r
                        <button type="button" id="fakinit-newplayers" class="fakinit-button btn btn-lg btn-block fakinit-endbuttons">Новые игроки</button>   \r
                    </form>\r
\r
                    <div class="pure-u-1"></div>\r
                    \r
                    <form class="pure-form">\r
                        <button type="button" id="fakinit-lobby-menu-censor" class="menu-button lobby-button fakinit-button button-xlarge pure-button pure-input-1">Меню цензуры</button><br>\r
                    </form>\r
                </div>\r
            </div>\r
        </div>\r
        ...
        <div class="state-gameplay pt-page-off fakinit-page fakinit-category-background">\r
            <div>\r
                ...
                <div class='container fakinit-gameplay-sign fakinit-gameplay-ready'>\r
                    <p class="fakinit-text"><span id="press-instruction" class="fakinit-text-instruction">Как будешь готов, нажми кнопку</span></p>\r
                    <button class='fakinit-ready-button fakinit-button btn btn-lg btn-block button-send'>Готов</button>\r
                </div>\r
                \r
                    ...
                    <div class="container">\r
                        <form class="form-inline">\r
                            <div class="form-group" id="fakinit-input-text">\r
                                <input id='enteredText' value='' type='text' class='form-control fakinit-input input-lg' autocapitalize='off' autocorrect='off' autocomplete='off' maxlength='45' placeholder='пиши здесь'/>\r
                                <span id="fakinit-submit-alert" class="help-block fakinit-text fakinit-text-instruction" style="color:white;"></span>\r
                            </div>\r
                            <button id="input-send" type="submit" class='fakinit-button btn button-input'>Отправить</button>\r
                        </form>\r
                    </div>\r
                </div>\r
\r
...
\r
        <div class="state-skip-instructions pt-page-off fakinit-page">\r
            <!-- <div style="height:100%;display:flex;flex-direction:column;"> -->\r
                <p><button class='fakinit-skip-button fakinit-button fakinit-button-secondary button-send'>Пропустить</button></p>\r
                <div class="fakinit-text fakinit-category-color">\r
                    <p class="fakinit-text-instruction ">Нажми ПРОПУСТИТЬ, если все знают, как играть</p>\r
                </div>\r
...
\r
        <div class="state-categories pt-page-off fakinit-page">\r
            <div id="fakinit-instruction-box-categories" class="fakinit-instruction-box">\r
                <p id="category-title" class="fakinit-title fakinit-category-color">Выбери категорию</p>\r
...
\r
        <div class="pt-page-off state-vote fakinit-page fakinit-category-background">\r
            ...
            <div id="fakinit-bar-vote" class="fakinit-bar fakinit-category-background-dark">\r
                <span id="fakinit-title-vote" class="fakinit-title fakinit-text-instruction">Кто же Жулик?</span>\r
            </div>\r
            <div class="container">\r
                <div class="">\r
                    ...
                    <p id="fakinit-vote-lock" class="fakinit-vote-lock"><span id="vote-lock-instruction" class="fakinit-text fakinit-text-instruction">Зафиксировать ответ</span></p>\r
                </div>\r
            </div>\r
        </div>\r
\r
        <div class="pt-page-off state-vote-locked fakinit-page fakinit-category-background">\r
            ...
            <div id="fakinit-bar-vote-locked" class="fakinit-bar fakinit-category-background-dark">\r
                <span id="fakinit-title-vote-locked" class="fakinit-title fakinit-text-instruction">Кто же Жулик?</span>\r
            </div>\r
            <div class="container">\r
                <div>\r
                    ...
                    <p class="fakinit-text"><span id="vote-locked-instruction" class="fakinit-text fakinit-text-instruction">Ответ зафиксирован!</span></p>\r
                    <p class="fakinit-text"><span id="vote-locked-waiting"class="fakinit-text fakinit-text-instruction">Ждём остальных игроков</span></p>\r
                </div>\r
            </div>\r
        </div>\r
    </div>\r
...
const zx = lc.extend({
    ...
    prevPlayerState: "",
    doneAnswering: !1,
    categoryFlavor: ["это весело", "сделай это", "мы верим в тебя", "это легко", "не заставляй всех ждать", "это лёгкая часть", "ну пожалуйста!", "это важно", "ты сможешь сделать это", "у тебя есть власть", "выбирай мудро", "твоё время сиять", "быстрее", "выбирай с умом", "наслаждайся", "твоя очередь", "настало твоё время"],
    events: {
    ...
    updatePlayer() {
        ...
        if (i && i === "Lobby") {
            ...
            if (f !== "PostGame" && f !== "PostGameCountdown" && le(".fakinit-change-name-dialog").show(), !t.isAllowedToStartGame) {
                le("#fakinit-lobby-text").html("Откинься на спинку и отдохни!"), this.showScreen(".state-lobby");
                return
            }
            f === "WaitingForMore" ? le("#fakinit-lobby-text").html("Ожидаем других игроков...") : f === "CanStart" ? (le("#fakinit-lobby-text").html("Нажми эту кнопку, когда все присоединились"), le("#fakinit-startgame").show()) : f === "Countdown" || f === "PostGameCountdown" ? (le("#fakinit-lobby-text").html("Нажми эту кнопку, чтобы отменить запуск"), le("#fakinit-stopcountdown").show()) : f === "PostGame" ? (le("#fakinit-lobby-text").html("что выберешь?"), le(".fakinit-endbuttons").show()) : le("#fakinit-lobby-text").html("<br />Не переключайтесь!<br>Ожидаем, когда VIP начнёт игру")
    ...
    updateAudience() {
        const t = this.model.get("room"),
            e = t ? t.state : "";
        switch (t.state === "Gameplay_Input" && (t.category = "Пиши-пропало"), this.setCategory(t.category), e) {
            case "Lobby":
                this.hideLobbyButtons(), le("#fakinit-lobby-text").html("Не переключайтесь!<br>Ожидаем, когда VIP начнёт игру"), this.showScreen(".state-lobby");
                break;
            case "Gameplay_Logo":
            case "Ready":
            case "Instructions":
            ...
            case "Gameplay_CategorySelection":
                le("#notchoosing").html(`${t.choosingPlayerName} выбирает категорию`), this.showScreen(".state-notchoosing");
                break;
            case "Gameplay":
            case "Gameplay_Go":
            case "Gameplay_Stop":
                ...
                break;
            case "Gameplay_Input":
                t.category = "Пиши-пропало", le(".fakinit-category").html(t.category), le(".fakinit-task").html("Не переключайтесь!<br>Игроки дают свои ответы"), le(".fakinit-gameplay-sign").hide(), this.showScreen(".state-gameplay");
                break;
            case "Vote": {
    ...
    setCategory(t) {
        if (le(".fakinit-category-background").removeClass("handsoftruth").removeClass("makingnoises").removeClass("facevalue").removeClass("yougottapoint").removeClass("numberpressure").removeClass("textyouup"), le(".fakinit-category-background-dark").removeClass("handsoftruth").removeClass("makingnoises").removeClass("facevalue").removeClass("yougottapoint").removeClass("numberpressure").removeClass("textyouup"), le(".fakinit-category-color").removeClass("handsoftruth").removeClass("makingnoises").removeClass("facevalue").removeClass("yougottapoint").removeClass("numberpressure").removeClass("textyouup"), t) {
            ...
            const e = t.replace(/\s/g, "").toLowerCase().replace("рукивверх", "handsoftruth").replace("забавнаямордашка", "facevalue").replace("покажипальцем", "yougottapoint").replace("сколькодашь?", "numberpressure").replace("пиши-пропало", "textyouup");
    ...
    sendInput() {
        ...
        return e.hide(), t.length === 0 ? (e.html("Невозможно ввести пустоту!"), e.show(), !1) : (this.client.send("SendMessageToRoomOwner", {
            answer: !0,
            msg: t
        }), !1)
    },
    ...
    sanitizeInput(t) {
        return t = t.replace(/[^A-Z0-9\u00A1\u0020-\u002F\u00BF-\u00FF\u0406-\u0408\u0410-\u044F\u0401\u0451\u0456-\u0458!?*$+\-’'_ .,=<>:;]/gi, ""), t
    },
    validateInput(t) {
        const e = le(t.target);
        let n = e.val();
