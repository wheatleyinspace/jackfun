...
<div style="display:none;">\r
    ...
    <button id="submit" class="button choice-button btn btn-lg submit">ОТПРАВИТЬ</button>\r
    ...
    Kx = mt.View.extend({
        ...
        <div class="footer">
            <div class="name"></div>
            <button aria-label="Удвоить ставку" class="doubleDown"></button>
        </div>`),
        events: {
    ...
    Qx = mt.View.extend({
        ...
        update() {
            ...
            const i = this.model.get("isAudience") ? "Соотнеси игрока к наиболее подходящей ему роли." : "Соотнеси игроков с их ролями";
...
const Zx = Vx.extend({
    ...
    parseBlob(t) {
        ...
        return e.playerInfo = e.playerInfo || {}, e.playerInfo.classes = e.playerInfo.classes || [], e.state === "Lobby" && (e.characters = []), e.state === "Lobby" && !e.allowDrawingsIfCameraDisabled && (e.choices = e.choices || [], e.choices.find(i => i.action === "toCamera") !== void 0 || (e.choices = e.choices.filter(i => i.action !== "toDraw"))), e.state === "Draw" && (e.thicknesses = [10], e.sketchOptions = {
            ...
            html: "Нарисуй себя"
        }, e.playerInfo.playerColor && (e.background = e.playerInfo.playerColor)), e.state === "MakeSingleChoice" && e.choices && e.choices.length > 0 && e.choices[e.choices.length - 1].text === "ЦЕНЗУРИРОВАТЬ ОТВЕТЫ" && (e.choices[e.choices.length - 1].className = "censorAnswers"), e.isAudience ? e.playerInfo.username = "ЗРИТЕЛЬ" : e.playerInfo.hidden = !0, e
    },
    getGameLayout(t) {
        switch (t) {
            case "Sortable":
