...
const $x = Et.View.extend({
    ...
    <div class="arrow"></div>
    <p>В случае, если другой комик использует ваш объект для победившей шутки, вы получите <em>БОНУСНЫЕ ОЧКИ</em>!</p>
</div>`,
    Ux = `<div class="joke-info">
    <div class="arrow"></div>
    <p>За <em>ПОЛОВИНУ</em> очков</p>
</div>`,
    Gx = Ma.extend({
        onRender() {
...
const Wx = xc.extend({
    ...
    parseBlob(t) {
        return t.playerInfo = t.playerInfo || {}, t.playerInfo.classes = t.playerInfo.classes || [], t.isAudience && (t.playerInfo.username = "ЗРИТЕЛЬ"), this.detectCatchphrase(t), this.detectFinalRound(t), t.state === "MakeSingleChoice" && t.announcePrompt && (t.textDescriptions = t.textDescriptions || [], t.textDescriptions.push({
            id: t.choiceId,
            category: "Prompt",
            text: t.prompt.html
        })), t
