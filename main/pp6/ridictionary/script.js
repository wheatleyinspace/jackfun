...
const Xx = Px.extend({
    ...
    parseBlob(t) {
        const e = t;
        if (e.classes = e.classes || [], e.playerInfo = e.playerInfo || {}, e.playerInfo.classes = e.playerInfo.classes || [], e.playerInfo.avatar = e.playerInfo.avatar || "Avatar_Other", e.playerInfo.classes.push(e.playerInfo.color), e.isAudience && (e.playerInfo.avatar = "Avatar_З", e.playerInfo.username = "ЗРИТЕЛЬ"), e.playerInfo.username) {
