    ...
    parseBlob(t) {
        if (t.classes = t.classes || [], t.state === "EnterSingleText") {
            ...
            n = n.map(i => i.indexOf("<DIV>") === -1 ? `<DIV>${i}</DIV>` : i), t.prompt.html = n.join(""), t.actions = [], t.actions.push({
                ...
                text: "Придумать за меня",
                key: "help"
            }), t.suggestions && t.suggestions.length > 0 && t.actions.push({
                text: "Идеи",
                action: "suggestion"
            })
        } else t.state === "MakeSingleChoice" && (t.choiceType && t.choiceType === "PlayerVote" && t.classes.push("playerVote"), t.type === "repeating" ? (t.classes.push("actionChoice"), t.maxVotes = this.client.isRole("player") ? 200 : 100) : t.classes.includes("actionChoice") && (t.type = "repeating", t.maxVotes = this.client.isRole("player") ? 200 : 100), t.prompt.text === "Жми, если думаешь, что рифма ЖЖЁТ" && (t.type = "repeating", t.maxVotes = this.client.isRole("player") ? 200 : 100));
