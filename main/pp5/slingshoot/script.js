...
const $x = Et.View.extend({
    ...
    zx = no.extend({
        ...
        update() {
            this.strings = this.model.get("strings"), this.model.get("gameCanContinue") ? (this.strings.button_sameplayers = "Начать следующий поединок", this.strings.button_newplayers = "Выйти") : (this.strings.button_sameplayers = "Те же игроки", this.strings.button_newplayers = "Новые игроки"), no.prototype.update.apply(this)
        }
    });
const Hx = La.extend({
