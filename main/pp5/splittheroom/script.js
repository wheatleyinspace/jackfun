...
const zx = Px.extend({
    ...
    parseBlob(t) {
        if (t.state === "EnterSingleText" && (t.placeholder || (t.placeholder = "Заполни пропуск..."), Object.prototype.hasOwnProperty.call(t, "counter") || (t.counter = !0), t.maxLength || (t.maxLength = 45)), t.state === "MakeSingleChoice") {
            if (t.scenario) {
