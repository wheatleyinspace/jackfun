...
const Fx = Ct.View.extend({
    ...
    <li class="pull-left button-pad">\r
        <div class="undoButton">\r
            <button id="undoButton" class="undo button block">Отменить</button>\r
        </div>\r
    </li>\r
    <li class="pull-right button-pad"> \r
    ...
    Gx = lr.extend({
        ...
        sendInput(t) {
            if (this.sketchpadComponent.getLines().length === 0) {
                Ot.show(Error("Нужно что-то нарисовать!"));
                return
            }
...
`,
    Wx = Hn.extend({
        defaults: Ke.extend({}, ro.prototype.model.defaults, {
            strings: {
                wait: "<div>ПОЖАЛУЙСТА, ПОДОЖДИТЕ!</div><div>Наш семинар вот-вот начнётся!</div>",
                vip_waiting: "<div>Ты VIP-участник!</div><div>Ждём, пока все участники займут свои места...<div>",
                vip_canStart: "<div>Ты VIP-участник!</div><div>Нажми эту кнопку, когда все участники будут готовы</div>",
                vip_cancel: "<div>Ты VIP-участник!</div><div>Нажми эту кнопку, чтобы отменить запуск</div>",
                vip_postgame: "<div>Ты VIP-участник!</div><div>Проведём ещё семинар?<div>",
                vip_episodes_menu: "Меню эпизодов",
                vip_episodes_unload: "Выгрузить эпизод",
                vip_episodes_report: "Пожаловаться на эпизод",
                vip_episodes_view_author: "Узнать автора",
                button_start: "Все здесь",
                button_cancel: "Отмена",
                button_changename: "Сменить имя",
                button_sameplayers: "Те же игроки",
