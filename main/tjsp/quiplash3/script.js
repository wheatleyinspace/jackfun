...
var Die = OL((Mie, KS) => {
    ...
    const qp = class {
        ...
        static sanitizeName(t) {
            return t.replace(/[^A-Z0-9\u00A1\u0020-\u002F\u00BF-\u00FF\u0406-\u0408\u0410-\u044F\u0401\u0451\u0456-\u0458\u2026!?*$+\-'_ .,]/gi, "").replace(/'/g, "\u2019")
        }
        static sanitizeInput(t) {
            return t = t.replace("\u2026", "..."), t.replace(/[^\u00A1\u0020-\u007E\u00BF-\u00FF\u0406-\u0408\u0410-\u044F\u0401\u0451\u0456-\u0458’]/gi, "")
        }
...
${r}`,
    ...
    const q3 = [169, 174, 8252, 8265, 8482, 8505, 8596, 8597, 8598, 8599, 8600, 8601, 8617, 8618, 9e3, 8986, 8987, 9167, 9193, 9194, 9195, 9196, 9197, 9198, 9199, 9200, 9201, 9202, 9203, 9209, 9210, 9410, 9642, 9643, 9654, 9664, 9723, 9724, 9725, 9726, 9728, 9729, 9730, 9731, 9732, 9742, 9745, 9748, 9749, 9752, 9757, 9760, 9762, 9763, 9766, 9770, 9774, 9775, 9784, 9785, 9786, 9792, 9794, 9800, 9801, 9802, 9803, 9804, 9805, 9806, 9807, 9808, 9809, 9810, 9811, 9824, 9827, 9829, 9830, 9832, 9851, 9854, 9855, 9874, 9875, 9876, 9877, 9878, 9879, 9881, 9883, 9884, 9888, 9823, 9889, 9895, 9898, 9899, 9904, 9905, 9917, 9918, 9924, 9925, 9928, 9934, 9935, 9937, 9939, 9940, 9961, 9962, 9968, 9969, 9970, 9971, 9972, 9973, 9974, 9975, 9976, 9977, 9978, 9981, 9986, 9989, 9992, 9993, 9994, 9995, 9996, 9997, 9999, 10002, 10004, 10006, 10013, 10017, 10024, 10035, 10036, 10052, 10055, 10060, 10062, 10067, 10068, 10069, 10071, 10083, 10084, 10085, 10133, 10134, 10135, 10145, 10160, 10175, 10548, 10549, 11013, 11014, 11015, 11035, 11036, 11088, 11093, 12336, 12349, 12951, 12953, 58634],
        ...
        n8 = (e, t) => {
            if (!/[^\u00A1\u0020-\u0022\u0024-\u0029\u002B-\u002F\u003A-\u007E\u00BF-\u00FF\u0406-\u0408\u0410-\u044F\u0401\u0451\u0456-\u0458\u2018-\u2019\u2026]/gi.test(e)) return t && e && e.length > t && (e = e.substring(0, t)), {
                result: e,
                charCount: e.length
            };
            const n = e.split("");
            ...
            for (let l = 0; l < n.length && (t ? s < t : !0); l += 1) {
                const c = n[l];
                if (/[\u00A1\u0020-\u0022\u0024-\u0029\u002B-\u002F\u003A-\u007E\u00BF-\u00FF\u0406-\u0408\u0410-\u044F\u0401\u0451\u0456-\u0458\u2018-\u2019\u2026]/gi.test(c)) a += c, s += 1;
                else if (t8(c)) {
                    if (a += c, an(c, z3)) {
                        l += 1;
                        const {
...
`,
    ...
    const nb = st(dre, [
        ...
        gre = {
            AVATAR_BLUE: "синий персонаж",
            AVATAR_CACTUS: "персонаж-кактус",
            AVATAR_COFFIN: "персонаж-гроб",
            AVATAR_GREEN: "зелёный персонаж",
            AVATAR_KITTEN: "персонаж-котёнок",
            AVATAR_MOON: "персонаж-луна",
            AVATAR_ORANGE: "оранжевый персонаж",
            AVATAR_PINK: "розовый персонаж",
            AVATAR_POOP: "персонаж-какашка",
            AVATAR_PURPLE: "фиолетовый персонаж",
            AVATAR_RED: "красный персонаж",
            AVATAR_STAR: "персонаж-звезда",
            AVATAR_TEAL: "бирюзовый персонаж",
            AVATAR_TEAR: "персонаж-слезинка",
            AVATAR_TRICLOPS: "трехглазый персонаж",
            AVATAR_YELLOW: "жёлтый персонаж",
            LOGO_GAME: "логотип Смехлыста 3",
            LOGO_1: "цифра 1 из пластилина",
            LOGO_2: "цифра 2 из пластилина",
            LOGO_3: "цифра 3 из пластилина",
            UGC: {
                TOGGLE_THRIPLASH_OFF: "обычное задание",
                TOGGLE_THRIPLASH_ON: "задание Трихлыста"
            }
        },
        mre = {
            AVATAR_SELECT: "Выбери своего персонажа"
        },
        vre = {
            INSTRUCTION: "Проголосуй за лучший вариант",
            THANKS: "Спасибо. Твой выбор:"
        },
        yre = {
            ANSWER_PLACEHOLDER: "ОТВЕЧАЙ ЗДЕСЬ",
            PROMPT_COUNTER: "Задание {current} из {total}",
            PROMPT_FINAL: "Финальное задание",
            SAFETY_QUIP_LABEL: "Ничего не приходит в голову? Используй спасалку",
            SAFETY_QUIP_SUBMIT: "Спасалка"
        },
        _re = {
            ALT: gre,
            LOBBY: mre,
