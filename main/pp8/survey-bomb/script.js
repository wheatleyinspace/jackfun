...
${r.message}`,
    ...
    const R4 = {
        ...
        L4 = {
            UGC: {
                VISIBILITY_CONTROLLER_OFF: "задания скрыты для игроков",
                VISIBILITY_CONTROLLER_ON: "задания показаны для игроков",
                VISIBILITY_SCREEN_OFF: "задания скрыты на экране",
                VISIBILITY_SCREEN_ON: "задания показаны на экране"
            }
        },
        k4 = {
            DISCONNECTED: "Соединение разорвано.",
            DRAWING_NOTHING: "Нужно что-то нарисовать!",
            PLAYER_KICKED: "Модератор исключил тебя из игры.",
            ROOM_DESTROYED: "Спасибо за игру!",
            ROOM_DISCONNECTED: "Отключено",
            TEXT_NAUGHTY: "Этот ввод недопустим. Пожалуйста, уважай других игроков.",
            TEXT_NOTHING: "Нужно что-то написать!",
            TITLE: "Ошибка"
        },
        P4 = "ЗАГРУЗКА",
        x4 = {
            JOINED_COUNT: "x | В игре {count} из {maxPlayers} игроков | В игре {count} из {maxPlayers} игроков",
            PLAYERS_NEEDED: "x | Нужен ещё {count} игрок | Нужно ещё {count} игрока",
            WAITING_FOR_VIP: "Ждём, пока {name} начнёт игру",
            WAITING_FOR_GAMEPAD: "Ожидание начала игры",
            GAME_STARTING: "Игра начинается",
            BUTTON_START: "Нажми для запуска игры",
            BUTTON_CANCEL: "Нажми для отмены"
        },
        D4 = {
            GALLERY_LINK: "Открыть галерею",
        ...
        B4 = {
            ...
            EPISODES_SELECT: "Или выбери эпизод:",
            EPISODES_WARNING: "Важно: пользовательский контент не проверяется",
            INSTRUCTION: {
                CREATE_TITLE: "для начала, введи название эпизода, который будет содержать твои задания, и нажми \"создать\".",
                LOAD: "создать или загрузить?",
                PUBLISH: "опубликовать эпизод",
                TITLE: "назови эпизод",
                TOGGLE_VISIBILITY: "показать/скрыть задания",
                WRITE: "пиши свои задания"
            },
            WARNING: {
                DELETE: "Ты уверен, что хочешь удалить этот эпизод?",
                TOS: "Делясь контентом, ты соглашаешься с [tos]Условиями использования[/tos]",
            ...
            PROMPT_PLACEHOLDER: "введи задание",
            PROMPTS_COUNT_HIDDEN: "({count} скрыто)",
            TITLE_PLACEHOLDER: "введи название"
        },
        j4 = {
            BROADCASTER: {
                SUBTEXT: "Аккаунт успешно подключён к Twitch-расширению Jackbox Audience Kit.",
                WARNING: "В ЭТОЙ ИГРЕ НЕ ВКЛЮЧЕНА ОПЦИЯ ЗРИТЕЛЕЙ"
            },
            RECONNECTED: {
                TEXT: "ПОДКЛЮЧЕНО",
                SUBTEXT: "Удачи!"
            ...
            RECONNECTING: {
                CONTROLLER: {
                    ...
                    SUBTEXT: "Повторное подключение (попытка {attempt} из 5)"
                },
                GAME: {
                    TEXT: "СОЕДИНЕНИЕ С ИГРОЙ ПРЕРВАНО",
                    SUBTEXT: "Выполняется повторное подключение"
                }
            }
        },
        G4 = {
...
`) + ae + `return __p
    ...
    function cG(e, t, r, n, s, o) {
        ...
        }, De(e.player.submitText || "ОТПРАВИТЬ"), 1)])], 512)])
    }
    const lG = He(nG, [
            ["render", cG]
        ]),
...
`,
    ...
    const qb = He(Bte, [
        ...
        Wte = {
            INSTRUCTION: {
                ORDERED: "Выбери дверь, которая, возможно, находится под номером {rank}",
                UNORDERED: "Выбери {amount} дверей с правильными ответами"
            },
            REMAINING: "Оставшиеся варианты: {remaining}"
        },
        Kte = {
        ...
        Hte = {
            FILTER_ERROR: "Это недопустимо, введи что-то другое!",
            INSTRUCTION: {
                AVATAR: "Выбери свой аватар",
                NAME_TEAM: "Предложи название команды",
                RANK_TEAM: "Выбери лучшие названия для команды"
            }
        },
        Vte = "Нет факелов",
        qte = {
            CONFIRM: "Да, да, я понял",
            SUBTEXT: {
                ATTENTION: "[b]ДЛЯ ИГРЫ НЕОБХОДИМА ВКЛЮЧЁННАЯ ОПЦИЯ ЗРИТЕЛЕЙ![/b]",
                BEST: "[b]ЛУЧШЕ ВСЕГО:[/b] Включить опцию комнаты с паролем и сказать пароль вашей команде",
                GOOD: "[b]ТОЖЕ НЕПЛОХО:[/b] Скрыть код комнаты и установить максимальное количество игроков",
                RECOMMEND: "Мы рекомендуем следующие настройки для игры в режиме стримера.",
                RESTART: "Если вы не сделали ничего из этого, может, стоит перезапустить игру?"
            },
            TEXT: "Добро пожаловать в режим стримера!"
        },
        Yte = {
            INSTRUCTION: "Запомни свой выбор",
            PICK_MORE: "Выбери ещё {amount}"
        },
        zte = "Поменять команду",
        Xte = "ПРОТИВ",
        Jte = {
            FINAL_CHANCE: {
                BOTH: "Если какая-то из команд ответит верно, игра закончится!",
                CURRENT: "Если команда противников ответит верно, игра закончится!",
                HEADER: "Ход на выбывание",
                RIVAL: "Если ваша команда ответит верно, игра закончится!"
            },
            LOSE: {
                HEADER: "Вы в ловушке",
                TEXT: ["Не переживайте, видимо, вы хороши на вкус.", "По крайней мере, другая команда счастлива.", "В следующий раз знайте больше о своих друзьях.", "Зато вы узнали многое друг о друге.", "Здесь кромешная темнота. Видимо, вас съест тьма.", "И что ещё хуже, вы промокли.", "Доставку оплачивать не нужно!", "Всё в порядке, Магнолия составит вам компанию.", "Наслаждайтесь этим затхлым воздухом.", "Ну, хотя бы название вашей команды было классным."]
            },
            SKIP_TUTORIALS: "Пропустить объяснения",
            UP_NEXT: {
                HEADER: "Ты следующий",
                TEXT: ["Приготовься! Ты будешь выбирать следующим.", "Будь внимательнее, ты выбираешь следующую дверь.", "На следующем ходу выбирать будешь ты… так что надейся, что они ошибутся!"]
            },
            WIN: {
                HEADER: "Вы выбрались",
                TEXT: ["Прекрасная работа!", "Командная работа – работа мечты.", "Не потратьте всё золото, которое вы украли, впустую.", "Наслаждайтесь свежим воздухом.", "Не забудьте оставить отзыв!", "Будьте уверены, с другой командой всё в порядке.", "Вы знаете своих друзей!", "Мы будем ждать вас снова.", "А настоящим сокровищем были друзья, потерянные в глубинах этой пещеры.", "Все будут вами гордиться."]
            }
        },
        Zte = {
            AUDIENCE: Wte,
        ...
        _ne = Je({
            ...
            data() {
                return {
                    avatarImages: {
                        0: {
                            alt: "искатель приключений с мечом",
                        ...
                        2: {
                            alt: "разбойник в шапочке из перьев",
                        ...
                        3: {
                            alt: "вор в капюшоне, который подбрасывает монетку",
                        ...
                        4: {
                            alt: "улитка с киркой, прикреплённой к раковине",
                        ...
                        5: {
                            alt: "элита с длинными волосами и драгоценным камнем",
                        ...
                        6: {
                            alt: "шахтёр с лопатой и черепом в руках",
                        ...
                        7: {
                            alt: "ребёнок верхом на черепахе",
                        ...
                        9: {
                            alt: "массивный гном-альпинист с большим полотном",
                        ...
                        10: {
                            alt: "короткий задумчивый гном в большой шляпе",
        ...
        fie = Je({
            ...
            computed: {
                finalChanceMsg() {
                    ...
                    return e && t ? this.$t("WAITING.FINAL_CHANCE.BOTH") : t ? this.$t("WAITING.FINAL_CHANCE.RIVAL") : e ? this.$t("WAITING.FINAL_CHANCE.CURRENT") : "Неизвестная команда может быть обречена после её выбора!"
                },
                hasTeamData() {
