...
const VC = Et.View.extend({
    ...
    showTwitchBroadcasterDialog(t) {
        ...
        e += "<div class='success'>Вы успешно подключены к Jackbox Audience Kit Twitch Extension.</div>", this.lacksAudience ? e += "<div class='warning'>В ЭТОЙ ИГРЕ НЕТ ФУНКЦИИ ЗРИТЕЛЕЙ</div>" : this.client.roomInfo.audienceEnabled || (e += "<div class='warning'>В ЭТОЙ ИГРЕ НЕТ ФУНКЦИИ ЗРИТЕЛЕЙ</div>"), kt.show("custom", {
            html: e,
            position: "bottom",
            timer: t,
            ...
            if (i !== "back" && i !== "censorConfirm" && i !== "activateContentId")
                if (i === "changeName") try {
                        const o = await kt.show("custom", {
                            ...
                            inputValidator: c => c ? c.length > 12 ? "Максимум 12 символов" : null : "Надо что-нибудь ввести!"
                        });
                        if (o.dismiss) return;
                        this.triggerMethod("client:message", {
                            name: o.value
                ...
                const o = "https://vk.com/topic-147727753_36770161?offset=last\&scroll=1",
...
Et.View.extend({
    ...
    showTwitchBroadcasterDialog(t) {
        ...
        e += `
            ...
            </div>`, this.lacksAudience ? e += "<div class='warning'>В ЭТОЙ ИГРЕ НЕТ ФУНКЦИИ ЗРИТЕЛЕЙ</div>" : this.client.roomInfo.audienceEnabled || (e += "<div class='warning'>В ЭТОЙ ИГРЕ НЕТ ФУНКЦИИ ЗРИТЕЛЕЙ</div>"), kt.show("custom", {
            html: e,
            position: "bottom",
            timer: t,
            backdrop: "transparent",
    ...
    <div id="game" class="game pt-pageholder">    
            ...
            <div class="container">
				...
				<div id="lobby-main-menu">
					...
					<form class="pure-form">                    
						<button type="button" id="drawful-startgame" class="lobby-button button-drawful button-xlarge pure-button pure-input-1">ВСЕ ЗДЕСЬ</button>
						<button type="button" id="drawful-stopcountdown" class="lobby-button button-drawful button-xlarge pure-button pure-input-1">ОТМЕНА</button>
						<button type="button" id="drawful-sameplayers" class="lobby-button button-drawful button-xlarge pure-button pure-input-1 drawful-endbuttons">ТЕ ЖЕ ИГРОКИ</button>
						<button type="button" id="drawful-newplayers" class="lobby-button button-drawful button-xlarge pure-button pure-input-1 drawful-endbuttons">НОВЫЕ ИГРОКИ</button>    
					</form>
					<br>
					<br>
					<div class="drawful-start-menu">
                        <button type="button" id="drawful-lobby-menu-ugc" class="menu-button lobby-button button-drawful button-drawful-black button-xlarge pure-button pure-input-1 drawful-text">Меню эпизодов</button><br>
    					<button type="button" id="drawful-lobby-menu-censor" class="menu-button lobby-button button-drawful button-drawful-black button-xlarge pure-button pure-input-1 drawful-text">Меню цензуры</button><br>
                    </div>
                ...
                <div id="lobby-ugc">
					...
					<button type="button" class="drawful-lobby-menu-back button-drawful button-drawful-black button-xlarge pure-button pure-input-1">Назад</button><br>
                    <div id="lobby-ugc-enter" class="lobby-ugc-option">
                        <form class="">
                        <div class="row">
                            <div class="col-xs-12">
                                <p id="lobby-ugc-help">Чтобы загрузить свой эпизод, в меню игры открой пункт "сделай сам", или введи ID эпизода (ABC-WXYZ).</p>
                                <p class="drawful-text-box">Загрузить эпизод по ID:</p>
                            </div>
                            <div class="col-xs-12">
                                <div class="input-group input-group-lg drawful-box-border">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="submit" id="lobby-ugc-submit" class="btn">Отправить</button>
                                    </span>
                                </div>
                            </div>
                        </div>
						<small class="help text-danger">Внимание: контент, созданный пользователями, не проверяется.</small>
                        </form>
						
                        <div class="drawful-ugc-previous">
                            <p>или выбери эпизод из списка:</p>
                    ...
                    <div id="lobby-ugc-choices" class="lobby-ugc-option">
                        ...
                        <button type="button" id="lobby-ugc-clear" class="button-drawful button-drawful-black button-xlarge pure-button">Выгрузить</button><br>
						<button type="button" id="lobby-ugc-report" class="button-drawful button-drawful-black button-xlarge pure-button">Каталог эпизодов</button>
						<button type="button" id="lobby-ugc-view-author" class="button-drawful button-xlarge pure-button">Показать автора</button>
                    </div>
                </div>
				...
				<div id="lobby-censor">
					...
					<p style="display:none;" class="drawful-player-censor-dialog drawful-confirm-dialog">
                        <span class="drawful-text drawful-text-box text-danger">Цензура удалит имя игрока, его аватар, ответы и рисунки. Ты уверен?</span>
                        <button class="drawful-player-censor-confirm button-drawful button-drawful-black">Да</button>
                        <button class="drawful-player-censor-cancel button-drawful">Нет</button>
                    </p>
					<table id="lobby-censor-players" class="drawful-list">
					</table>
                    <div class="drawful-text">нажми <span class="censor-button-image censor-button-black"></span> и игра для этого игрока завершится, а его аватар, ответы и рисунки будут удалены.</div>
				</div>
        ...
        <div class="pt-page-off state-nothing drawful2-page">
            <div id="drawful-nothing-skip-round-container">
                <button type="button" class="drawful-skip-round-button button-drawful button-xlarge pure-button pure-input-1">пропустить!</button>
            </div>
        ...
        <div class="pt-page-off state-drawing-sent drawful2-page">
            <div class="container">
                ...
                <span class='drawful-text'>спасибо за рисунок!</span><br />
            </div>
        </div>

        <div class="pt-page-off state-drawing-done drawful2-page">
            <div class="container">
                <br /><span class='drawful-text'>время вышло!</span><br />
            </div>
        </div>        
        ...
        <div class="pt-page-off state-enterlie drawful2-page">
            <div class="container">
                ...
                <form class="pure-form" id="drawful-enterlie-field">
                    <div class="">
                        <input id="drawful-lie-input" name="drawful-lie" class="lowercase pure-input-1 jbg-input" type="text" maxlength="45" placeholder="придумай название" autocapitalize="off" autocorrect="off" autocomplete="off">
                    </div>
                    <div class=" right">
                        <button type="submit" id="drawful-submitlie" class="button-drawful button-drawful-black button-xlarge pure-button  right">отправить</button>
        ...
        <div class="pt-page-off state-chooselie drawful2-page">
            <div class="container">
                <p style="display:none;" class="drawful-chooselie-censor-dialog drawful-confirm-dialog">
                    <span class="drawful-text drawful-text-box text-danger">удалить все ответы этого игрока, включая будущие рисунки. ты уверен?</span>
                    <button class="drawful-chooselie-censor-confirm button-drawful button-drawful-black">Да</button>
                    <button class="drawful-chooselie-censor-cancel button-drawful">Нет</button>
                </p>
        ...
        <div class="pt-page-off state-liereceived drawful2-page">
            <div class="container">
                <br /><span class='drawful-text'>название введено!<br />ожидаем остальных игроков.</span><br />
            </div>
        </div>

        <div class="pt-page-off state-lyingdone drawful2-page">
            <div class="container">
                <br /><span class='drawful-text'>готово!</span><br />
            </div>
        </div>        
        ...
        <div class="pt-page-off state-draw drawful2-page">
            <!-- <div class="container"> -->
                <span id="drawful-prompt" class='prompt drawful-text'>пожалуйста, нарисуй:</span><br />
                <span id="drawful-instructions" class='instructions drawful-text'>рисунок самого себя!</span><br />
                ...
                <div class="row button-bar">
                    ...
                    <div class="col-xs-5">
                        <form class="pure-form">
                            ...
                            <button type="submit" id="drawful-submitdrawing" class="submit-drawing button-drawful button-drawful-black button-large col-xs-12" style="margin-top: 0px;">отправить</button>
		...
		<div class="pt-page-off state-audience-chose drawful2-page">
            <div class="container">
                <br /><span class='drawful-text'>спасибо за выбор, зритель!</span><br />
            </div>
        </div>
		
        <div class="pt-page-off drawful2-page" id="state-ugc">
            <div id="ugc-submit-dialog" style="display:none;" class="container">
                <div class="drawful-text-box">Делясь контентом, ты соглашаешься с <a href="http://www.jackboxgames.com/terms-of-service/" target="_blank">Условиями использования</a>.</div>
                <button id="ugc-submit-confirm" class="button-drawful">Согласиться и поделиться</button><br />
                <button id="ugc-submit-cancel" class="button-drawful">Вернуться в меню</button>
            </div>
            <div id="ugc-container" class="container">
                <div id="ugc-episode-name"></div>
    			<div id="ugc-new" class="ugc-option">
    				<button type="button" id="ugc-new-button" class="button-drawful button-drawful-black button-xlarge pure-button pure-input-1">Создать новый эпизод</button>
    			</div>

                <p class="ugc-option drawful-text-box ugc-load">Предыдущие эпизоды:</p>
                ...
                <!--<div id="ugc-screen-main" class="ugc-screen">-->
    				...
    				<div id="ugc-title" class="ugc-option">
    					<p class="drawful-text-box">
                            <span class='drawful-text'>Для начала введи название эпизода, который будет содержать твои задания, и нажми Создать.</span>
                        </p>
                        <form class="pure-form">
                            <div class="">
                            ...
                            <div class="right">
                                <button type="submit" id="ugc-title-button" name="ugc-title-button" class="ugc-form-button button-drawful button-drawful-black button-xlarge pure-button  right">Создать</button>
                                <button type="button" id="ugc-exit-button" class="ugc-form-button button-drawful button-drawful-black button-xlarge pure-button left">Вернуться к эпизодам</button>
                            </div>
                    ...
                    <div id="ugc-toggle-visibility" class="ugc-option">
                        <span class="drawful-text">Показать/скрыть задания</span><br/>
                        ...
                        <form class="pure-form">
                            <div class="">
                                <input id="ugc-add-input" class="lowercase ugc-input pure-input-1 jbg-input ugc-option ugc-add" type="text" placeholder="Введи задание..." autocapitalize="off" autocorrect="off" autocomplete="off"/>
                            </div>
                            <div class="ugc-option ugc-add">
                                <button type="submit" id="ugc-add-button" name="ugc-add-button" class="ugc-form-button button-drawful button-drawful-black button-xlarge pure-button right">Добавить задание</button>
                            </div>
                            <div id="ugc-close" class="ugc-option">
                                <button type="button" id="ugc-close-button" class="ugc-form-button button-drawful button-drawful-black button-xlarge pure-button left">Закрыть</button>
                            </div>
                            <div id="ugc-save" class="ugc-option">
                                <button type="save" id="ugc-save-button" class="ugc-form-button button-drawful button-drawful-black button-xlarge pure-button left">Готово</button>
                            </div>
                        </form>
                ...
                <!--<div id="ugc-screen-confirm" class="ugc-screen">-->
                    <div id="ugc-unlock" class="ugc-option">
                        <button type="button" id="ugc-unlock-button" class="button-drawful button-drawful-black button-xlarge pure-button pure-input-1">Редактировать</button>
                    </div>
                    
                    <div id="ugc-save" class="ugc-option">
                        <button type="save" id="ugc-save-button" class="button-drawful button-drawful-black button-xlarge pure-button pure-input-1">Сохранить</button>
                    </div>
                <!--</div>-->
                
                <!--<div id="ugc-screen-post-save" class="ugc-screen">-->
    			    <div id="ugc-submit" class="ugc-option">
                        <button type="button" id="ugc-submit-button" class="button-drawful button-drawful-black button-xlarge pure-button pure-input-1">Опубликовать</button>
                    </div>
                    <div id="ugc-play" class="ugc-option">
                        <button type="button" id="ugc-play-button" class="button-drawful button-drawful-black button-xlarge pure-button pure-input-1">Играть</button>
                    </div>
                    <div id="ugc-delete" class="ugc-option">
                        <button type="button" id="ugc-delete-button" class="button-drawful button-drawful-black button-xlarge pure-button pure-input-1 ugc-remove-content-button">Удалить</button>
                        <div id="ugc-remove-content-dialog" style="display:none;" class="drawful-confirm-dialog">
                            <span class="drawful-text drawful-text-box text-danger">Ты уверен, что хочешь удалить этот эпизод?</span>
                            <button id="ugc-remove-content-confirm" class="button-drawful button-drawful-black">Да</button>
                            <button id="ugc-remove-content-cancel" class="button-drawful">Нет</button>
                        </div>

                    </div>

                    <div id="ugc-exit" class="ugc-option">
                        <button type="button" id="ugc-exit-button" class="button-drawful button-drawful-black button-xlarge pure-button pure-input-1">Вернуться к эпизодам</button>
                    </div>
                <!--</div>-->
            </div>
        </div>
        ...
        <div class="pt-page-off state-audience drawful2-page" id="state-wait">
            <p id="audience-welcome" class="drawful-text drawful-text-box">приветствуем в зрительном зале.</p>
        </div>
    </div>
</div>
`;
const Hx = VC.extend({
    ...
    prevRoomState: "",
    audienceMessages: ["приветствуем в зрительном зале.<br />это весело!", "приветствуем в зрительном зале.<br />начинаем через пару мгновений", "приветствуем в зрительном зале.<br />веселье начнётся в любую секунду", "приветствуем в зрительном зале.<br />мы ждали тебя", "приветствуем в зрительном зале.<br />это не так весело, как самому владеть игрой, но лучше, чем сидеть и ничего не делать", "приветствуем в зрительном зале.<br />чем больше, тем веселее", "приветствуем в зрительном зале.<br />один из нас, один из нас", "приветствуем в зрительном зале.<br />пожалуйста, не шелестите фантиками во время игры", "приветствуем в зрительном зале.<br />настало наше время", "приветствуем в зрительном зале.<br />любишь наблюдать, да?", "приветствуем в зрительном зале.<br />тягостные минуты ожидания", "приветствуем в зрительном зале.<br />пожалуйста, не организовывайте переворот", "приветствуем в зрительном зале.<br />чувствуй себя как дома", "приветствуем в зрительном зале.<br />надеемся, тебе нравится оценивать людей", "приветствуем в зрительном зале.<br />сделай глубокий вдох, скоро всё начнётся", "приветствуем в зрительном зале.<br />наслаждайся", "приветствуем в зрительном зале.<br />все в зале - наши особые гости!", "приветствуем в зрительном зале.<br />мечты сбываются!", "приветствуем в зрительном зале.<br />зрители - это тоже хороший способ поиграть!", "приветствуем в зрительном зале.<br />эта фраза написана специально для тебя. :3", "приветствуем в зрительном зале.<br />займите ваше место", "приветствуем в зрительном зале.<br />итак... что новенького?"],
    authorMessages: ["Ты это нарисовал.<br />Отвлекись на секундочку и посмотри на своё отражение.", "Ты это нарисовал.<br />Может, пора к доктору?", "Ты это нарисовал.<br />Вот так вот.", "Ты это нарисовал.<br />Это твой шедевр.", "Ты это нарисовал.<br />Отсюда один путь - наверх!", "Ты это нарисовал.<br />Расслабься.", "Ты это нарисовал.<br />Насладись моментом.", "Ты это нарисовал.<br />Слишком поздно что-то изменить.", "Ты это нарисовал.<br />Некого больше винить.", "Ты это нарисовал.<br />Твоя жизнь изменилась навсегда.", "Ты это нарисовал.<br />Ура?", "Ты это нарисовал.<br />Без комментариев.", "Ты это нарисовал.<br />Могло быть и хуже.", "Ты это нарисовал.<br />Почувствуй вину.", "Ты это нарисовал.<br />Итак...", "Ты это нарисовал.<br />Не волнуйся, скоро это закончится.", "Ты это нарисовал.<br />Надо радоваться, не надо напрягаться.", "Ты это нарисовал.<br />Это искусство.", "Ты это нарисовал.<br />От души благодарим тебя.", "Ты это нарисовал.<br />Дай пять!", "Ты это нарисовал.<br />А пока можешь вздремнуть.", "Ты это нарисовал.<br />Гордись этим.", "Ты это нарисовал.<br />Сойдёт.", "Ты это нарисовал.<br />Смирись с этим.", "Ты это нарисовал.<br />Будь готов к последствиям.", "Ты это нарисовал.<br />Сделал дело - гуляй смело.", "Ты это нарисовал.<br />Хорошо, всё будет хорошо.", "Ты это нарисовал.<br />Возможно, ты заслуживаешь уважения.", "Ты это нарисовал.<br />Спасибо.", "Ты это нарисовал.<br />Лучший подарок - сделанный своими руками.", "Ты это нарисовал.<br />Ха-ха-ха-ха-ха.", "Ты это нарисовал.<br />Вот за это я люблю тебя.", "Ты это нарисовал.<br />Бывает.", "Ты это нарисовал.<br />Надеюсь, это сработает.", "Ты это нарисовал.<br />А что, если ты - единственный человек во вселенной, а всё остальное - лишь плод твоего воображения?", "Ты это нарисовал.<br />Повеселимся?", "Ты это нарисовал.<br />Это получит признание только после твоей смерти.", "Ты это нарисовал.<br />Впрочем, ты это уже знаешь.", "Ты это нарисовал.<br />Да-да, ты.", "Ты это нарисовал.<br />Только история оценит тебя.", "Ты это нарисовал.<br />Наслаждайся.", "Ты это нарисовал.<br />И это хорошо."],
    events: {
    ...
    async update() {
        ...
        if (j(".ugc-option").hide(), n === "RoomFull") {
            kt.show(Error("Комната заполнена!"), {
                willClose: () => {
                    window.location.reload(!0)
                }
            }), this.onResize();
        ...
        if (n === "GameLocked") {
            kt.show(Error("Игра уже началась. Дождитесь начала следующей."), {
                willClose: () => {
                    window.location.reload(!0)
                }
            }), this.onResize();
        ...
        if (t.hasPicture === !1) {
            ...
            this.startDrawingInterface(t.playerColors, "рисунок самого себя!"), this.onResize(), this.joiningInterfaceIsUp = !0;
            return
        }
        if (this.joiningInterfaceIsUp = !1, i === "Lobby") {
            ...
            j(".menu-button").hide(); {
                ...
                c === "WaitingForMore" ? j("#drawful-lobby-text").html("Ожидаем других игроков...") : c === "CanStart" ? (j("#drawful-startgame").html("все здесь"), j("#drawful-lobby-text").html("Нажми эту кнопку, когда все присоединились"), j("#drawful-startgame").removeClass("button-drawful-red"), j("#drawful-startgame").show()) : c === "Countdown" ? (j("#drawful-lobby-text").html("Нажми эту кнопку, чтобы отменить запуск"), j("#drawful-stopcountdown").show()) : c === "PostGame" && (j("#drawful-lobby-text").html("Что выберешь?"), j(".drawful-endbuttons").show(), this.showPostgameDrawings(e.artifact))
            }
            if (t.canDoUGC) {
                if (j(".lobby-ugc-option").hide(), e.formattedActiveContentId ? (e.isLocal ? j("#lobby-ugc-choices-content-id").html("локальный контент загружен") : j("#lobby-ugc-choices-content-id").html(`публичный контент загружен<br><span class="lobby-episode-id capitalize">${e.formattedActiveContentId}</span>`), j("#lobby-ugc-choices").show(), !e.isLocal && t.canReport ? j("#lobby-ugc-report").show() : j("#lobby-ugc-report").hide(), !e.isLocal && t.canViewAuthor ? j("#lobby-ugc-view-author").show() : j("#lobby-ugc-view-author").hide()) : j("#lobby-ugc-enter").show(), t.history !== void 0) {
            ...
            t.lastUGCResult && !t.lastUGCResult.success && t.lastUGCResult.error ? j("#lobby-ugc-error").html(`<span>ОШИБКА: Эпизод не найден!</span>`) : j("#lobby-ugc-error").html(""), this.showScreen(".state-lobby")
        } else if (i === "Gameplay_Logo" || i === "Logo") this.showLogo(t.showSkip);
        else if (i === "Gameplay_Round") j(".round-text").html(`РАУНД ${e.round}`), this.showScreen(".state-round");
            ...
            if (n === "Gameplay_EnterLie") {
                if (!this.activeScreen !== ".state-enterlie" && (t.canSkipRound ? (this.setSkipButtonState(!1), j("#drawful-enterlie-skip-round-container").show()) : j("#drawful-enterlie-skip-round-container").hide(), t.isAuthor ? (j("#drawful-lie-input").hide(), j("#drawful-enterlie-field").hide(), j("#drawful-submit-alert").hide(), j("#drawful-submitlie").hide(), j(".state-enterlie .author-text").html(this.authorMessages[Math.floor(Math.random() * this.authorMessages.length)])) : (j(".state-enterlie .author-text").html(""), j("#drawful-lie-input").val(""), j("#drawful-lie-input").show(), j("#drawful-enterlie-field").show(), j("#drawful-submitlie").show(), j("#drawful-submit-alert").hide())), t.showError) {
                    ...
                    j("#drawful-submit-alert").html("ты близок к правильному названию или ответу другого игрока! введи другой ответ!"), c.addClass("alert-info"), c.removeClass("alert-danger"), c.show()
                }
            ...
            if (c) {
                t.isAuthor ? j("#chooselikes-choice").html("") : this.client.isRole("player") ? j("#chooselikes-choice").html(t.chosen ? `твой выбор: ${t.chosen.isCensored?"************":t.chosen.text}` : "ответ не был выбран.") : j("#chooselikes-choice").html(""), j("#chooselikes-text").html(this.client.isRole("player") ? "поставь бонусные лайки" : "поставь бонусный лайк");
                let m = "";
                ...
                j("#chooselie-text").html("каково настоящее название?");
                let m = "";
    ...
    startGame(t) {
        ...
        return n.hasClass("button-drawful-red") ? (this.client.send("SendMessageToRoomOwner", {
            ...
            startGame: !0
        }), n.removeClass("button-drawful-red")) : (n.html("Ты уверен?"), n.addClass("button-drawful-red"), t.stopPropagation()), !1
    },
    stopCountdown() {
    ...
    lobbyUgcReport() {
        const t = "https://vk.com/topic-147727753_36770161?offset=last\&scroll=1",
    ...
    submitDrawing() {
        if (this.currentCanvas.isClean) return alert("надо что-то нарисовать!"), !1;
    ...
    setSkipButtonState(t) {
        t ? (j(".drawful-skip-round-button").addClass("button-drawful-red"), j(".drawful-skip-round-button").html("Ты уверен?")) : (j(".drawful-skip-round-button").removeClass("button-drawful-red"), j(".drawful-skip-round-button").html("пропустить (это оскорбление)"))
    },
    submitSkipRound(t) {
    ...
    submitLie() {
        ...
        if (t = t.replace(/\s\s+/g, " ").trim(), t.length === 0) {
            ...
            return j("#drawful-submit-alert").html("введи свой ответ!"), e.removeClass("alert-info"), e.addClass("alert-danger"), e.show(), !1
        }
    ...
    sanitize(t) {
        return t = t.replace(/[^A-Z0-9\u00A1\u0020-\u002F\u00BF-\u00FF\u0406-\u0408\u0410-\u044F\u0401\u0451\u0456-\u0458!?*$+\-’'_ .,=<>]/gi, "").replace(/'/g, "\u2019").trim(), Rt.htmlEscape(t)
    },
    validateInput(t) {
        const e = j(t.target);
        let n = e.val();
